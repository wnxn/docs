# 部署Glusterfs存储服务端
> 此安装方法仅供测试Kubesphere，搭建Glusterfs集群请参考Glusterfs[官方网站](https://docs.gluster.org/en/latest/Install-Guide/Install/#for-ubuntu)，搭建 Heketi 请参考[官方文档](https://github.com/heketi/heketi/blob/master/docs/admin/readme.md)

## 准备材料
机器资源

|hostname        |IP     |OS       |device|CPU|RAM|
|:---------------:|:------:|:------:|:---:|:--:|:--:|
|glusterfs-server1  |172.20.1.5|Ubuntu16.04.4| /dev/vda 100Gi, /dev/vdc 300Gi|2Core|2GB|
|glusterfs-server2  |172.20.1.6|Ubuntu16.04.4| /dev/vda 100Gi, /dev/vdc 300Gi|2Core|2GB|
